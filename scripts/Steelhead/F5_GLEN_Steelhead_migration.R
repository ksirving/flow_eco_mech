...
png("figures/Application_curves/Depth/GLEN_Migration_In_Depth_Q.png", width = 500, height = 600)
...
head(melt_time)
write.csv(melt_time, "output_data/F5_GLEN_SH_migration_depth_time_stats.csv")
...
write.csv(total_days, "output_data/F5_GLEN_migration_depth_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/F5_GLEN_migration_depth_total_days_long.csv")
...
png("figures/Application_curves/nodes/GLEN_Migration_In_Velocity_Q.png", width = 500, height = 600)
...
write.csv(melt_time, "output_data/F5_GLEN_SH_migration_velocity_time_stats.csv")


png("figures/Application_curves/Depth/GLEN_migration_in_velocity_perc_time_above_threshold_annual.png", width = 500, height = 600)
...
ggplot(melt_time, aes(x = water_year, y=value)) +
  ...
  labs(title = "GLEN: Time within discharge limit in relation to Velocity",
       y = "Time (%)",
...
write.csv(total_days, "output_data/F5_GLEN_migration_in_velocity_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/F5_GLEN_migration_in_velocity_total_days_long.csv")
...
png("figures/Application_curves/Depth/GLEN_Migration_OUT_Depth_Q.png", width = 500, height = 600)
...
melt_time <- rename(melt_time, Time_Period = variable)
head(melt_time)
write.csv(melt_time, "output_data/F5_GLEN_SH_smolts_depth_time_stats.csv")
...
write.csv(total_days, "output_data/F5_GLEN_smolts_depth_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/F5_GLEN_smolts_depth_total_days_long.csv")
...
png("figures/Application_curves/nodes/GLEN_Migration_OUT_Velocity_Q.png", width = 500, height = 600)
...
write.csv(melt_time, "output_data/F5_GLEN_SH_smolts_velocity_time_stats.csv")
...
write.csv(total_days, "output_data/F5_GLEN_smolts_in_velocity_total_days.csv")

...
png("figures/Application_curves/Depth/F57C_Migration_OUT_Depth_Q.png", width = 500, height = 600)
...
melt_time <- rename(melt_time, Time_Period = variable)
head(melt_time)
write.csv(melt_time, "output_data/F5_F57C_SH_smolts_depth_time_stats.csv")
...
write.csv(total_days, "output_data/F5_F57C_smolts_depth_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/F5_F57C_smolts_depth_total_days_long.csv")
...
png("figures/Application_curves/nodes/F57C_Migration_OUT_Velocity_Q.png", width = 500, height = 600)
...
write.csv(melt_time, "output_data/F5_F57C_SH_smolts_velocity_time_stats.csv")
...
write.csv(total_days, "output_data/F5_F57C_smolts_in_velocity_total_days.csv")

...
hyd_dep <- hyd_dep %>%
  ...
  mutate(season = ifelse(month == 12 | month == 1 | month == 2 | month == 3 | month == 4| month == 5 | month == 6, 
                         paste("Migration_season"), paste("other_season") ))
...
png("figures/Application_curves/Depth/F57C_Migration_In_Depth_Q.png", width = 500, height = 600)
...
write.csv(melt_time, "output_data/F5_F57C_SH_migration_depth_time_stats.csv")


png("figures/Application_curves/Depth/F57C_migration_depth_perc_time_above_threshold_annual.png", width = 500, height = 600)
...
ggplot(melt_time, aes(x = year, y=value)) +
  ...
  labs(title = "F57C: Time within discharge limit in relation to Depth",
       y = "Time (%)",
...
write.csv(total_days, "output_data/F5_F57C_migration_depth_total_days.csv")
...
total_days <- total_days %>%
  mutate(season = ifelse(month %in% non_critical, "non_critical", "Migration_season") ) #%>%
...
## save df
write.csv(melt_days, "output_data/F5_F57C_migration_depth_total_days_long.csv")
...
## plot all ts
png("figures/Application_curves/Depth/F57C_migration_depth_lob_rob_mc_no_days_within_Q.png", width = 500, height = 600)
...
## plot by year
png("figures/Application_curves/Depth/F57C_migration_depth_lob_rob_mc_no_days_within_Q_by_year.png", width = 500, height = 600)
...
ggplot(melt_days) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  labs(title = "F57C: Number of days within discharge limit in relation to Depth (by year)",
       y = "Number of days per Month",
       x = "Month") #+ theme_bw(base_size = 15)
dev.off()

## plot by season/critical period
png("figures/Application_curves/Depth/F57C_migration_depth_lob_rob_mc_no_days_within_Q_by_season.png", width = 500, height = 600)
...
ggplot(melt_days) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  labs(title = "F57C: Number of days within discharge limit in relation to Depth (Seasonal)",
       y = "Number of days per Month",
       x = "Year") #+ theme_bw(base_size = 15)
dev.off()
...
MC_curve
## main channel values
newx1a <- approx(x = MC_curve$y, y = MC_curve$x, xout = max(new_dataM$value))$y ## does not go up to 3.1, use max value instead
newx1a
...
png("figures/Application_curves/nodes/F57C_Migration_In_Velocity_Q.png", width = 500, height = 600)
...
ggplot(hyd_vel, aes(x = Q, y=value)) +
  ...
  geom_point(data = subset(hyd_vel, variable =="vel_m_MC"), aes(y=max(new_dataM$value), x=newx1a), color="green") +
...
write.csv(melt_time, "output_data/F5_F57C_SH_migration_velocity_time_stats.csv")


png("figures/Application_curves/Depth/F57C_migration_in_velocity_perc_time_above_threshold_annual.png", width = 500, height = 600)
...
ggplot(melt_time, aes(x = year, y=value)) +
  ...
  facet_wrap(~position, scales="free_x", nrow=3) +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  labs(title = "F57C: Time within discharge limit in relation to Velocity",
       y = "Time (%)",
       x = "Year") #+ theme_bw(base_size = 15)
...
write.csv(total_days, "output_data/F5_F57C_migration_in_velocity_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/F5_F57C_migration_in_velocity_total_days_long.csv")
...
## plot all ts
png("figures/Application_curves/Velocity/F57C_migration_in_velocity_lob_rob_mc_no_days_within_Q.png", width = 500, height = 600)
...
ggplot(melt_days) +
  ...
  facet_wrap(~position, nrow=3) +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  labs(title = "F57C: Number of days within discharge limit in relation to Velocity",
       y = "Number of days per Month",
       x = "Year") #+ theme_bw(base_size = 15)
dev.off()

## plot by year
png("figures/Application_curves/Velocity/F57C_migration_in_velocity_lob_rob_mc_no_days_within_Q_by_year.png", width = 500, height = 600)
...
ggplot(melt_days) +
  ...
  facet_wrap(~year+position, scale="free_x", nrow=4) +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  labs(title = "F57C: Number of days within discharge limit in relation to Velocity (by year)",
       y = "Number of days per Month",
       x = "Month") #+ theme_bw(base_size = 15)
dev.off()

## plot by season/critical period
png("figures/Application_curves/Velocity/F57C_migration_in_velocity_lob_rob_mc_no_days_within_Q_by_season.png", width = 500, height = 600)
...
ggplot(melt_days) +
  ...
  facet_wrap(~season +position, nrow=2) +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  labs(title = "F57C: Number of days within discharge limit in relation to Velocity (Seasonal)",
       y = "Number of days per Month",
       x = "Year") #+ theme_bw(base_size = 15)
dev.off()

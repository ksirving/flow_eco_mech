...
write.csv(limits, "output_data/C4_F300_clad_shear_Q_limits.csv")

## plot with thresholds
labels <- c(shear_pa_LOB = "Left Over Bank", shear_pa_MC = "Main Channel", shear_pa_ROB = "Right Over Bank")

png("figures/Application_curves/Shear/F300_clad_shear_stress_Q.png", width = 500, height = 600)
...
write.csv(melt_time, "output_data/C4_F300_clad_shear_stress_time_stats.csv")
...
write.csv(total_days_per_month01, "output_data/C3_F300_total_days_clad_shear.csv")

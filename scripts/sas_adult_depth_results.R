...
write.csv(time_stats_all, "results/SAS_Depth_Adult_time_stats.csv")
...
td <- Filter(function(x) grepl("F1", x), td)
...
write.csv(total_days_all,"results/SAS_Depth_Adult_total_days.csv")

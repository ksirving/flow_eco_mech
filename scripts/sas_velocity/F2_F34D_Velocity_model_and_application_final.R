...
png("figures/Application_curves/nodes/F34D_Velocity_Q.png", width = 500, height = 600)
...
png("figures/Application_curves/nodes/F34D_Velocity_TS.png", width = 500, height = 600)
...
save(all_data, file="output_data/F2_F34D_SAS_adult_velocity_discharge_probability_time_series_all_columns.RData")
names(all_data)
## keep columns velocity, datetime, Q date_num & prob_fit
new_data <- all_data[order(all_data$date_num),]

save(new_data, file="output_data/F2_F34D_SAS_adult_velocity_discharge_probability_time_series_red_columns.RData")
...
save(new_data, file="output_data/F2_F34D_SAS_velocity_adult_discharge_probs_2010_2017_TS.RData")
...
png("figures/Application_curves/Depth/F34D_adult_velocity_prob_Q_thresholds.png", width = 500, height = 600)
...
png("figures/Application_curves/Velocity/F34D_adult_velocity_perc_time_above_threshold_annual.png", width = 500, height = 600)
...
png("figures/Application_curves/Velocity/F34D_adult_velocity_perc_time_above_threshold_winter.png", width = 500, height = 600)
...
png("figures/Application_curves/Velocity/F34D_adult_velocity_perc_time_above_threshold_critical.png", width = 500, height = 600)
...
write.csv(total_days, "output_data/F2_F34D_adult_velocity_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/F2_F34D_adult_velocity_total_days_long.csv")
...
## plot all ts
png("figures/Application_curves/Velocity/F34D_adult_velocity_lob_rob_mc_no_days_within_Q.png", width = 500, height = 600)
...
## plot by year
png("figures/Application_curves/Velocity/F34D_adult_velocity_lob_rob_mc_no_days_within_Q_by_year.png", width = 500, height = 600)

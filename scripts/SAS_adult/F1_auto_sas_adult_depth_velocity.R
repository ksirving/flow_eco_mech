...
## save out
save(all_data, file=paste("output_data/F1_", NodeName, "_adult_depth_discharge_probability.RData", sep=""))
...
save(all_data, file=paste("output_data/F1_", NodeName, "_depth_adult_discharge_probs_2010_2017_TS.RData", sep=""))
...
file_name = paste("figures/Application_curves/Depth/", NodeName, "_adult_depth_prob_Q_thresholds.png", sep ="")

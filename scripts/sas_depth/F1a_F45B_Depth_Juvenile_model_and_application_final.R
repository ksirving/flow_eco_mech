...
png("figures/Application_curves/nodes/F45B_Depth_Q.png", width = 500, height = 600)
...
dev.off()
## plot time series
png("figures/Application_curves/nodes/F45B_Depth_TS.png", width = 500, height = 600)
...
ggplot(hyd_dep, aes(x = date_num, y=value)) +
  ...
  facet_wrap(~variable, scales="free_x", nrow=3, labeller=labeller(variable = labels)) +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), legend.position = "none") +
  labs(title = "F45B: Depth ~ Time Series",
       y = "Depth (cm)",
...
save(all_data, file="output_data/F1_F45B_juvenile_depth_discharge_probability_time_series_all_columns.RData")
...
save(new_data, file="output_data/F1_F45B_juvenile_depth_discharge_probability_time_series_red_columns.RData")
...
save(new_data, file="output_data/F1_F45B_depth_juvenile_discharge_probs_2010_2017_TS.RData")


# probability as a function of discharge -----------------------------------


load( file="output_data/F1_F45B_depth_juvenile_discharge_probs_2010_2017_TS.RData")
head(new_data)
...
write.csv(limits, "output_data/F1_F45B_juvenile_Q_limits.csv")

# plot discharge points ---------------------------------------------------
unique(new_data$variable)
png("figures/Application_curves/Depth/F45B_juvenile_depth_prob_Q_thresholds.png", width = 500, height = 600)
labels <- c(depth_cm_LOB = "Left Over Bank", depth_cm_MC = "Main Channel", depth_cm_ROB = "Right Over Bank")
...
ggplot(new_data, aes(x = Q, y=prob_fit)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), legend.position = "none") +
  labs(title = "F45B: Juvenile/Depth: Probability ~ Q",
       y = "Probability",
       x = "Q (cfs)") #+ theme_bw(base_size = 15)
...
write.csv(melt_time, "output_data/F1_F45B_juvenile_depth_time_stats.csv")
...
png("figures/Application_curves/Depth/F45B_juvenile_depth_perc_time_above_threshold_annual.png", width = 500, height = 600)
...
png("figures/Application_curves/Depth/F45B_juvenile_depth_perc_time_above_threshold_non_critical.png", width = 500, height = 600)
...
png("figures/Application_curves/Depth/F45B_juvenile_depth_perc_time_above_threshold_critical.png", width = 500, height = 600)
...
write.csv(total_days, "output_data/F1_F45B_juvenile_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/F1_F45B_juvenile_total_days_long.csv")

library(scales)

## plot all ts
png("figures/Application_curves/Depth/F45B_juvenile_depth_lob_rob_mc_no_days_within_Q.png", width = 500, height = 600)
...
dev.off()
## plot by year
png("figures/Application_curves/Depth/F45B_juvenile_depth_lob_rob_mc_no_days_within_Q_by_year.png", width = 500, height = 600)
...
png("figures/Application_curves/Depth/F45B_juvenile_depth_lob_rob_mc_no_days_within_Q_by_season.png", width = 500, height = 600)

...
non_critical <- c(1,2,3,4,11,12) ## winter months
critical <- c(5:10) ## summer months
...
png("figures/Application_curves/Depth/LA11_adult_depth_perc_time_above_threshold_non_critical.png", width = 500, height = 600)
...
png("figures/Application_curves/Depth/LA11_adult_depth_perc_time_above_threshold_critical.png", width = 500, height = 600)

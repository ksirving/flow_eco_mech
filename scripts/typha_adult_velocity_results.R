...
write.csv(time_stats_all, "/Users/katieirving/Documents/git/flow_eco_mech/results/Typha_Adult_Velocity_time_stats.csv")
...
write.csv(total_days_all,"/Users/katieirving/Documents/git/flow_eco_mech/results/Typha_Adult_Velocity_total_days.csv")

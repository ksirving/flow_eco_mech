...
write.csv(limits, "output_data/F4_LA8_sas_fry_depth_Q_limits.csv")

## plot with thresholds
labels <- c(depth_cm_LOB = "Left Over Bank", depth_cm_MC = "Main Channel", depth_cm_ROB = "Right Over Bank")

png("figures/Application_curves/Depth/LA8_SAS_Fry_depth_Q.png", width = 500, height = 600)
...
time_stats
write.csv(time_stats, "output_data/F4_LA8_time_stats_fry_depth.csv")
...
write.csv(total_days_per_month01, "output_data/F4_LA8_number_of_days_fry_depth.csv")
...
write.csv(limits, "output_data/F1_LA8_fry_velocity_Q_limits.csv")


## plot with thresholds
labels <- c(depth_cm_LOB = "Left Over Bank", depth_cm_MC = "Main Channel", depth_cm_ROB = "Right Over Bank")

png("figures/Application_curves/Depth/LA8_SAS_Fry_velocity_Q.png", width = 500, height = 600)
...
time_stats
write.csv(time_stats, "output_data/F4_LA8_time_stats_fry_velocity.csv")
...
write.csv(total_days_per_month01, "output_data/F4_LA8_number_of_days_fry_velocity.csv")

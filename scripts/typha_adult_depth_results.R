...
write.csv(time_stats_all, "/Users/katieirving/Documents/git/flow_eco_mech/results/Typha_Adult_Depth_time_stats.csv")
...
write.csv(total_days_all,"/Users/katieirving/Documents/git/flow_eco_mech/results/Typha_Adult_Depth_total_days.csv")

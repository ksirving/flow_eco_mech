...
write.csv(time_stats_all, "results/Willow_Seedling_Shear_Stress_time_stats.csv")
...
write.csv(total_days_all,"results/Willow_Seedling_Shear_Stress_total_days.csv")

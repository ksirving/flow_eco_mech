...
write.csv(time_stats_all, "results/Steelhead_Migration_Velocity_time_stats.csv")
...
write.csv(total_days_all,"results/Steelhead_Migration_Velocity_total_days.csv")

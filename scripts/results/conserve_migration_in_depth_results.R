...
write.csv(time_stats_all, "results/Steelhead_Migration_Depth_time_stats_conserve.csv")
...
write.csv(total_days_all,"results/Steelhead_Migration_Depth_total_days_conserve.csv")

...
ts <- Filter(function(x) grepl("conserve", x), ts)
...
write.csv(time_stats_all, "results/Steelhead_Migration_Velocity_time_stats_conserve.csv")
...
td <- Filter(function(x) grepl("conserve", x), td)
...
write.csv(total_days_all,"results/Steelhead_Migration_Velocity_total_days_conserve.csv")

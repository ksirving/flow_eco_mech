...
limits
write.csv(limits, "output_data/C1_LA2_clad_depth_Q_limits.csv")

png("figures/Application_curves/Depth/LA2_clad_depth_prob_Q_thresholds.png", width = 500, height = 600)
...
ggplot(new_data, aes(x = Q, y=prob_fit)) +
  ...
  labs(title = "LA2: Cladophora/Depth: Probability ~ Q",
       y = "Probability",
...
write.csv(melt_time, "output_data/C1_LA2_clad_Depth_time_stats.csv")
...
png("figures/Application_curves/Depth/C1_LA2_clad_Depth_perc_time_above_threshold_annual.png", width = 500, height = 600)
...
png("figures/Application_curves/Depth/C1_LA2_clad_Depth_perc_time_above_threshold_winter.png", width = 500, height = 600)
...
png("figures/Application_curves/Depth/C1_LA2_clad_Depth_perc_time_above_threshold_critical.png", width = 500, height = 600)
...
write.csv(total_days, "output_data/C1_LA2_clad_Depth_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/C1_LA2_clad_Depth_total_days_long.csv")
...
## plot all ts
png("figures/Application_curves/Depth/C1_LA2_clad_Depth_lob_rob_mc_no_days_within_Q.png", width = 500, height = 600)
...
## plot by year
png("figures/Application_curves/Depth/C1_LA2_clad_Depth_lob_rob_mc_no_days_within_Q_by_year.png", width = 500, height = 600)
...
png("figures/Application_curves/Depth/C1_LA2_clad_Depth_lob_rob_mc_no_days_within_Q_by_season.png", width = 500, height = 600)
